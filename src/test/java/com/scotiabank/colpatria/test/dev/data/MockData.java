...
public class MockData {
	...
	public static Employee employeeNum5(){
		State state = new State(1L, "activo");
		City city = new City(2L, "Rio de Plata");
		return new Employee(1L,"pablo","ferandes","vazques",city,"carr", new Date(949381200000L),"3201525521","Desarrollador", new Date(new Date().getTime() +999999) ,"pablito123@gmail.com",55555,state, new Date());
	}public static Employee employeeNum6(){
		State state = new State(1L, "activo");
		City city = new City(2L, "Rio de Plata");
		return new Employee(1L,"pablo","ferandes","vazques",city,"Carrera 123 # .", new Date(949381200000L),"3201525521","Desarrollador", new Date(new Date().getTime() +999999) ,"pablito123@gmail.com",55555,state, new Date());
	}
